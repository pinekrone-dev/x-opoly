...
export default function App() {
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch(() => setBilling({ configured: false, publishableKey: null, active: true, status: 'unknown', periodEnd: null, portalAvailable: false, priceLabel: '$29 / month', canMintCodes: false }))
